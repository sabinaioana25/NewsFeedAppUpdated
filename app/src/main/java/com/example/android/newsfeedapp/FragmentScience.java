...
public class FragmentScience extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerViewScience = (RecyclerView) rootView.findViewById(R.id.recycler_view_science);
        recyclerViewScience.setAdapter(articleAdapter);
        recyclerViewScience.setHasFixedSize(true);
        recyclerViewScience.setNestedScrollingEnabled(false);
        recyclerViewScience.setLayoutManager(layoutManagerTop);
    ...
    public void refreshRecyclerView() {
        if (isConnected()) {
            getLoaderManager().restartLoader(0, null, FragmentScience.this);
        } else {
            swipeRefreshLayout.setRefreshing(false);
