...
public class FragmentHealthcare extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerViewHealthcare = (RecyclerView) rootView.findViewById(R.id.recycler_view_healthcare);
        recyclerViewHealthcare.setAdapter(articleAdapter);
        recyclerViewHealthcare.setHasFixedSize(true);
        recyclerViewHealthcare.setNestedScrollingEnabled(false);
    ...
    public void refreshRecyclerView() {
        if (isConnected()) {
            getLoaderManager().restartLoader(0, null, FragmentHealthcare.this);
        } else {
            swipeRefreshLayout.setRefreshing(false);
